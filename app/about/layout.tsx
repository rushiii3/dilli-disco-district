...
export default function Layout({ children }: { children: ReactNode }) {
  return <div className='lg:py-10 lg:px-16 flex items-center justify-center relative top-0 left-0 w-full min-h-[400px] lg:h-screen h-[calc(var(--vh,1vh)*100)] bg-[url("https://mschfplaysvenmo.com/img/textured-background.jpg")] bg-no-repeat bg-cover bg-center'>
    ...
    `,
          ...
          <div className=" h-full p-[40px_15px] relative w-full">
            ...
            <div className="absolute left-[50%] bottom-[8px] items-center justify-center w-full">
              <p >DDD</p>
